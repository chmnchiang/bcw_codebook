...
void pre() {
	string ss[8];
	ss[0] = "....xxxxxxxxxxxx...xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.....";
	ss[1] = "....x....x....xx...xx....x........xx...xx...xx...x..x..";
	ss[2] = "....x....x....xx...xx....x........xx...xx...xx...x..x..";
	ss[3] = "....xxxxxxxxxxxxxxxxxxxxxxxxxx....xxxxxxxxxxxx...xxxxxx";
	ss[4] = "....xx........x....x....xx...x....xx...x....xx...x..x..";
	ss[5] = "....xx........x....x....xx...x....xx...x....xx...x..x..";
	ss[6] = "....xxxxxxxxxxx....xxxxxxxxxxx....xxxxxxxxxxxxxxxx.....";
	REP(i,7) {
		int pos = 0;
		REP1(j,1,9) {
			s[j][i] = ss[i].substr(pos,5);
			pos += 5;
		}
		s[0][i] = ss[i].substr(pos,5);
		pos += 5;
		s[10][i] = ss[i].substr(pos,5);
		pos += 5;
		assert(pos == SZ(ss[i]));
	}
}
